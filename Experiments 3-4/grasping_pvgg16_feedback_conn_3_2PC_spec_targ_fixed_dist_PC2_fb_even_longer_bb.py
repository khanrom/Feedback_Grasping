...
class PVGG16SeparateHP(PNetSeparateHP):
    def __init__(self, backbone, build_graph=False, random_init=False, ff_multiplier=(0.35,0.4), fb_multiplier=(0.25,0.4), er_multiplier=(0.01,0.01)):
        ...
        pmodule = Sequential(ConvTranspose2d(512, 256, kernel_size=(10, 10), stride=(4, 4), padding=(3, 3)), ReLU(inplace=True))
        ...
        def fw_hook2(m, m_in, m_out):
            ...
            return e[0]
        self.backbone.features_compress[38].register_forward_hook(fw_hook2)
