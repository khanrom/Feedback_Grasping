...
class PVGG16SeparateHP(PNetSeparateHP):
    def __init__(self, backbone, build_graph=False, random_init=False, ff_multiplier=(0.2,0.4,0.4,0.4), fb_multiplier=(0.05,0.1,0.1,0.1), er_multiplier=(0.01,0.01,0.01,0.01)):
        super().__init__(backbone, 4, build_graph, random_init, ff_multiplier, fb_multiplier, er_multiplier)
        ...
        def fw_hook2(m, m_in, m_out):
            ...
            return e[0]
        self.backbone.features_compress[11].register_forward_hook(fw_hook2)
        ...
        def fw_hook3(m, m_in, m_out):
            ...
            return e[0]
        self.backbone.features_compress[21].register_forward_hook(fw_hook3)


        # PCoder number 4                                                                                                                                                                                                      
        pmodule = Sequential(ConvTranspose2d(256, 256, kernel_size=(14, 14), stride=(2, 2), padding=(6, 6)), ReLU(inplace=True))
        self.pcoder4 = PCoderN(pmodule, False, self.random_init)
        def fw_hook4(m, m_in, m_out):
            ...
            return e[0]
        self.backbone.features_compress[28].register_forward_hook(fw_hook4)
